...
Enterprise customers receive an elevated support tier with a maximum response time of **2 business days** (compared to 4 business days for Pro). This faster response time makes sure critical issues are addressed with even greater urgency for enterprise deployments.
