...
Each Pro customer is encouraged to implement our [license gem integrity verification](Pro-Getting-Started#license-gem-integrity-verification) flow that makes sure license consistency provided via our Gem server.

On top of that, to make sure the stability and security of the system:
...
- We monitor the integrity of all the licenses using automated tools to make sure they are not compromised.
...
- Karafka Pro provides [script](Pro-Getting-Started#license-gem-integrity-verification) you can include in your CI/CD pipeline to make sure license integrity.
