...
!!! tip "Quiet and Stop Commands Limitation"
    ...
    Quiet and Stop commands do not function with Karafka processes operating in [Embedded](Infrastructure-Embedding) or [Swarm](Infrastructure-Swarm-Multi-Process) mode. This limitation arises because, in these modes, the Karafka process itself is not directly responsible for its state management.
