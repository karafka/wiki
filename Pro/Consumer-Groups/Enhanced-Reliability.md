...
For a deeper dive into the nuances and technicalities of this feature, refer to the dedicated [Cleaner API documentation](Pro-Cleaner-API).
...
For more detailed information on how Enhanced Supervision for Swarm Nodes works and how to implement it in your Karafka Pro setup, refer to the [Enhanced Swarm](Pro-Enhanced-Swarm-Multi-Process) documentation.
