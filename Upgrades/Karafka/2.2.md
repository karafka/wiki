...
As always, make sure you have upgraded to the most recent version of `2.1` before upgrading to `2.2`.

If you are not using Kafka ACLs, there is no action you need to take.

If you are using Kafka ACLs and you have set up permissions for `karafka_admin` group, this name has now been changed and is subject to Consumer Name Mapping.
