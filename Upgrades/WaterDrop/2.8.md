...
## License Changed From MIT to LGPL With a Commercial Option

WaterDrop's license changed from MIT to the GNU Lesser General Public License version 3.0 (LGPL), with an additional commercial license available. There is no commercial code in this repository -- the commercial license exists for companies that are unable to use LGPL-licensed software for legal reasons.
