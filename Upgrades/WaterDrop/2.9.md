...
!!! note "Experiencing Issues?"
    ...
    If you experience any issues with the `:fd` polling mode, [open an issue](https://github.com/karafka/waterdrop/issues/new) on the WaterDrop GitHub repository. Your feedback will help improve the FD mode before the `:thread` mode is removed.
