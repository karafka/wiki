...
Note, this **is** a **breaking** release, hence `2.5.0`.
...
2. Before `2.5.0` there was always a chance of partial dispatches via `produce_many_` methods. Now you can get the info on all the errors via `error.occurred`.
