...
Karafka `2.4` relies on Web UI `0.9+`. Because of new concepts and capabilities introduced in Karafka Web UI `0.9`, do not forget to run `bundle exec karafka-web migrate` after upgrading for every environment using Karafka Web UI.
