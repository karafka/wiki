...
|----------------------|--------------|-------------------------------------------------------------------------------------------------------------------|
| [processing_backend](https://github.com/karafka/karafka/wiki/Processing-messages#processing-backends)    | Symbol      | :inline or :sidekiq depending on where and how you want to process your messages |
